...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fa fa-refresh" aria-hidden="true" onclick='window.location.replace("/admin/postulacion");'><span>Recargar</span></a></li>
</ol>
@endsection
@section('contenido')
<?php
